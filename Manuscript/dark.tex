...
Why might this be the case?
  ...
  \subsection{2. The literature is too technical and/or important details are difficult to locate}
   ...
   Within many comparative methods assumptions and caveats can be found in the Introduction, Methods, Results and/or Discussion of a paper. 
    ...
    When combined with the vast literature on comparative methods it becomes easy to miss pertinent details. 
     We recently reviewed papers discussing the assumptions and limitations of phylogenetic independent contrasts \citep{felsenstein1985phylogenies}, including how they are related to phylogenetic generalised least squares models \citep{garland2000using,rohle2006comment,blomberg2012independent}. 
    ...
    Methods developers are not responsible for users conducting due diligence or reading the literature. 
