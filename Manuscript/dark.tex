...
May not be doable... List too many assumptions...
Discourse pages – forums for particular things. Dark “advice”.
Reduces time needed. 
Phylobabble
...
A obvious solution to all these problems is for methods-developers and methods-users to collaborate more. The benefits to methods-users is obvious, but methods-developers can gain extra datasets to test their ideas on, people who will discover corner cases and bugs in their software before it get released, and gain an appreciation of . 
A big difficulty with collaboration 
